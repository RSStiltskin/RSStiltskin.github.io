...
function TopLLeg(){
  ...
  THREE.ImageUtils.crossOrigin = '';
  var legs = THREE.ImageUtils.loadTexture('https://github.com/RSStiltskin/RSStiltskin.github.io/blob/master/rv/spiderleg.jpg'); 
  this.unionlleg = new THREE.Mesh( new THREE.SphereGeometry(8,20,20), new THREE.MeshLambertMaterial({map: legs}) );
  this.toplleg = new THREE.Mesh( new THREE.CylinderGeometry(8,4,16,15,10), new THREE.MeshLambertMaterial({map: legs}) );
