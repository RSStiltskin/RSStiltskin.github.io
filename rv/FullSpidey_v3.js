...
function TopLLeg(){
  ...
  this.unionlleg = new THREE.Mesh( new THREE.SphereGeometry(8,20,20), new THREE.MeshLambertMaterial({color:0xFF0000,emissive:0x2E2E2E, specular:0xFFFF00}) );
  this.toplleg = new THREE.Mesh( new THREE.CylinderGeometry(8,4,16,15,10), new THREE.MeshLambertMaterial({color:0xFF0000,emissive:0x2E2E2E, specular:0xFFFF00}) );
